...
namespace ConsoleToolkit
{
    ...
    internal class JSONLoader
    {
        ...
        private string countriesPath = Path.Combine("Resources", "Countries.json"); // Cesta k JSON souboru se zeměmi
        private string dicesSettingsPath = Path.Combine("Resources", "DicesSettings.json"); // Cesta k JSON souboru s nastavením kostek
        private string alphabetsPath = Path.Combine("Resources", "Alphabets.json"); // Cesta k JSON souboru s abecedami
        private string magic8BallAnswersPath = Path.Combine("Resources", "Magic8BallAnswers.json"); // Cesta k JSON souboru s odpověďmi Magic 8 Ball
        private string numbersSettingsPath = Path.Combine("Resources", "NumbersSettings.json"); // Cesta k JSON souboru s nastavením čísel
        private string passwordSettingsPath = Path.Combine("Resources", "PasswordSettings.json"); // Cesta k JSON souboru s nastavením hesla
        private string teamsSettingsPath = Path.Combine("Resources", "TeamsSettings.json"); // Cesta k JSON souboru s nastavením teamů
