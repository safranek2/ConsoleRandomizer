...
namespace ConsoleToolkit
{
    ...
    internal class PasswordGenerator
    {
        ...
        private Dictionary<string, string> chars; // Slovník pro uchování typů znaků a jejich hodnot.

        private int minLength; // Minimální délka hesla.
        private int maxLength; // Maximální délka hesla.
