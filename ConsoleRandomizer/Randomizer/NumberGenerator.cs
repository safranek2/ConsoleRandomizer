...
namespace ConsoleToolkit
{
    ...
    internal class NumbersGenerator
    {
        ...
        public NumbersGenerator()
        {
            ...
            maxNumbers = jsonLoader.LoadNumbersSettingsFromJSON();
        }

        private Random random = new Random();
        private ErrorController errorController = new ErrorController();

        private int maxNumbers; // Maximální počet čísel, které lze vygenerovat.
        ...
        public void Display()
        {
            ...
            if (maxNumbers > 0)
            {
                ...
                while (true)
                {
                    Console.Write("Enter a number of numbers from 1 to " + maxNumbers + " or 'exit' to return to the menu: ");
